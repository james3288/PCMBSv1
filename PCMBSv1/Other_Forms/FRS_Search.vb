...
#Region "MOVABLE FORM FUNCTIONS"
    ...
    End Sub
#End Region
    Private Sub FSearch_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.BackColor = ColorTranslator.FromHtml("#0C0F16")

        panelHeader.BackColor = ColorTranslator.FromHtml("#1A293A")
        btnSearch.BackColor = ColorTranslator.FromHtml("#80A006")
